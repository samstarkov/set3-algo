...
double GetAnsWithBigZone(std::vector<double>& data) {
...
double GetAnsWithSmallZone(std::vector<double>& data) {
  double x1 = data[0], y1 = data[1], r1 = data[2];
  double x2 = data[3], y2 = data[4], r2 = data[5];
  double x3 = data[6], y3 = data[7], r3 = data[8];
...
int main() {
  ...
  //double ans = GetAnsWithBigZone(data);
  double ans = GetAnsWithSmallZone(data);
